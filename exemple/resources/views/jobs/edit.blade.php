    ...
    <form method="POST" action="/jobs/{{ $job->id }}">
        ...
        <div x-data="{ isRemote: {{ $job->location === 'Remote' ? 'true' : 'false' }} }" class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    ...
                    <div class="sm:col-span-4">
                        <div>
                            <label class="inline-flex items-center">
                                <input type="checkbox" name="remote" id="remote" x-model="isRemote" value="1"
                    ...
                    <div class="sm:col-span-4" x-show="!isRemote">
                        ...
                        <input type="text" name="location" id="location" x-bind:disabled="isRemote"
                            class="block w-full rounded-md border-0 py-1.5 px-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            ...
            <div class="mt-6 flex items-center justify-between gap-x-6">
                ...
                <div>
                    <button form="delete-job" class="rounded-md bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">Delete</button>
                </div>
